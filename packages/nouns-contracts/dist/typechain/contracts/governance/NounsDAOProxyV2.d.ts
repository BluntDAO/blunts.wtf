...
export interface NounsDAOProxyV2Interface extends utils.Interface {
    ...
    getFunction(nameOrSignatureOrTopic: "_setImplementation" | "admin" | "implementation" | "latestProposalIds" | "nouns" | "pendingAdmin" | "pendingVetoer" | "proposalCount" | "proposalThresholdBPS" | "quorumParamsCheckpoints" | "quorumVotesBPS" | "timelock" | "vetoer" | "votingDelay" | "votingPeriod"): FunctionFragment;
