...
export interface NounsDAOStorageV1Interface extends utils.Interface {
    ...
    getFunction(nameOrSignatureOrTopic: "admin" | "implementation" | "latestProposalIds" | "nouns" | "pendingAdmin" | "proposalCount" | "proposalThresholdBPS" | "proposals" | "quorumVotesBPS" | "timelock" | "vetoer" | "votingDelay" | "votingPeriod"): FunctionFragment;
