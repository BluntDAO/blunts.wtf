...
export interface NounsDAOStorageV2Interface extends utils.Interface {
    ...
    getFunction(nameOrSignatureOrTopic: "admin" | "implementation" | "latestProposalIds" | "nouns" | "pendingAdmin" | "pendingVetoer" | "proposalCount" | "proposalThresholdBPS" | "quorumParamsCheckpoints" | "quorumVotesBPS" | "timelock" | "vetoer" | "votingDelay" | "votingPeriod"): FunctionFragment;
