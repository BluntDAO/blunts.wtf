...
export interface NounsTokenHarnessInterface extends utils.Interface {
    ...
    getFunction(nameOrSignatureOrTopic: "DELEGATION_TYPEHASH" | "DOMAIN_TYPEHASH" | "approve" | "balanceOf" | "burn" | "checkpoints" | "contractURI" | "currentNounId" | "dataURI" | "decimals" | "delegate" | "delegateBySig" | "delegates" | "descriptor" | "getApproved" | "getCurrentVotes" | "getPriorVotes" | "isApprovedForAll" | "isDescriptorLocked" | "isMinterLocked" | "isSeederLocked" | "lockDescriptor" | "lockMinter" | "lockSeeder" | "mint" | "mintMany" | "mintSeed" | "mintTo" | "minter" | "name" | "nonces" | "noundersDAO" | "numCheckpoints" | "owner" | "ownerOf" | "proxyRegistry" | "renounceOwnership" | "safeTransferFrom(address,address,uint256)" | "safeTransferFrom(address,address,uint256,bytes)" | "seeder" | "seeds" | "setApprovalForAll" | "setContractURIHash" | "setDescriptor" | "setMinter" | "setNoundersDAO" | "setSeeder" | "supportsInterface" | "symbol" | "tokenByIndex" | "tokenOfOwnerByIndex" | "tokenURI" | "totalSupply" | "transferFrom" | "transferOwnership" | "votesToDelegate"): FunctionFragment;
    ...
    encodeFunctionData(functionFragment: "currentNounId", values?: undefined): string;
    ...
    encodeFunctionData(functionFragment: "mintMany", values: [string, BigNumberish]): string;
    encodeFunctionData(functionFragment: "mintSeed", values: [
        string,
        BigNumberish,
        BigNumberish,
        BigNumberish,
    ...
    decodeFunctionResult(functionFragment: "currentNounId", data: BytesLike): Result;
...
export interface NounsTokenHarness extends BaseContract {
    ...
    functions: {
        ...
        mintMany(to: string, amount: BigNumberish, overrides?: Overrides & {
            from?: string | Promise<string>;
        }): Promise<ContractTransaction>;
        mintSeed(to: string, background: BigNumberish, body: BigNumberish, accessory: BigNumberish, head: BigNumberish, glasses: BigNumberish, overrides?: Overrides & {
            from?: string | Promise<string>;
        }): Promise<ContractTransaction>;
        mintTo(to: string, overrides?: Overrides & {
            from?: string | Promise<string>;
        }): Promise<ContractTransaction>;
    ...
    callStatic: {
        ...
        mintMany(to: string, amount: BigNumberish, overrides?: CallOverrides): Promise<void>;
        mintSeed(to: string, background: BigNumberish, body: BigNumberish, accessory: BigNumberish, head: BigNumberish, glasses: BigNumberish, overrides?: CallOverrides): Promise<void>;
