...
export interface NounsDAOExecutorTestInterface extends utils.Interface {
    ...
    getFunction(nameOrSignatureOrTopic: "GRACE_PERIOD" | "MAXIMUM_DELAY" | "MINIMUM_DELAY" | "acceptAdmin" | "admin" | "cancelTransaction" | "delay" | "executeTransaction" | "harnessAcceptAdmin" | "harnessSetAdmin" | "pendingAdmin" | "queueTransaction" | "queuedTransactions" | "setDelay" | "setPendingAdmin"): FunctionFragment;
