...
export interface NounsDAOExecutorV2TestInterface extends utils.Interface {
    ...
    getFunction(nameOrSignatureOrTopic: "GRACE_PERIOD" | "MAXIMUM_DELAY" | "MINIMUM_DELAY" | "NAME" | "acceptAdmin" | "admin" | "cancelTransaction" | "delay" | "executeTransaction" | "harnessAcceptAdmin" | "harnessSetAdmin" | "initialize" | "pendingAdmin" | "queueTransaction" | "queuedTransactions" | "sendERC20" | "sendETH" | "setDelay" | "setPendingAdmin" | "upgradeTo" | "upgradeToAndCall"): FunctionFragment;
    ...
    encodeFunctionData(functionFragment: "harnessAcceptAdmin", values: [string]): string;
...
export interface NounsDAOExecutorV2Test extends BaseContract {
    ...
    functions: {
        ...
        harnessAcceptAdmin(administered: string, overrides?: Overrides & {
            from?: string | Promise<string>;
        }): Promise<ContractTransaction>;
    ...
    callStatic: {
        ...
        harnessAcceptAdmin(administered: string, overrides?: CallOverrides): Promise<void>;
